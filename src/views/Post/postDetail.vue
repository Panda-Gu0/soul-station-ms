        ...
        <el-card style="margin: 8px">
            ...
            <div class="post-box">
                ...
                <div class="data-box">
                    ...
                    <span class="data-item">创建时间：{{ timeFormat(postDetail.create_time) }}</span>
                    ...
                    <span class="data-item">
                        ...
                        <template v-if=" postDetail.tags.length > 0">
                            <span v-for="item in postDetail.tags">{{ `${item.name} / ` }}</span>
                        </template>
                            <span v-else>无</span>
                    </span>
                </div>
...
<style lang="less" src="../../assets/style/post/postDetail/index.less" scoped>
